      ...
      <div className="flex flex-col justify-center items-center min-h-screen px-4">
        <div className="w-full max-w-md">
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 mb-6">
            <h2 className="text-xl font-semibold text-center mb-6 text-gray-900">로그인</h2>
            ...
            <div className="space-y-4">
              ...
              <Button 
                ...
                variant="outline" 
                className="w-full flex items-center justify-center gap-3 py-6 border-2 border-gray-200 hover:border-gray-300 hover:bg-gray-50 transition-all font-medium"
                disabled={loading}
              >
              ...
              <Button 
                ...
                className="w-full flex items-center justify-center gap-3 py-6 bg-[#FEE500] hover:bg-[#FDD800] text-gray-900 border-0 transition-all font-medium"
                disabled={loading}
              >
              ...
              <Button 
                ...
                className="w-full flex items-center justify-center gap-3 py-6 bg-black hover:bg-gray-800 text-white border-0 transition-all font-medium"
                disabled={loading}
              >
                {loading && authProvider === 'apple' ? (
